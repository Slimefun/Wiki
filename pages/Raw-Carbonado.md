Raw Carbonado is a [Resource](https://github.com/Slimefun/Slimefun4/wiki/Resources) that can be used to craft [Carbonado](https://github.com/Slimefun/Slimefun4/wiki/Carbonado).
